		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#NominationApproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"NominationApproval-display": {
								"semanticObject": "NominationApproval",
								"action": "display",
								"description": "Nomination Approval",
								"title": "Nomination Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ZANOC.zemployeeapprovenoc",
									"url": sap.ui.require.toUrl("ZANOC/zemployeeapprovenoc")
								}
							}
						}
					}
